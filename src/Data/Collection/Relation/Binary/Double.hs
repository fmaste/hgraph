...
getCodomain (BinaryRelation _ relatedFrom) = DCM.getKeys relatedFrom
...
getCodomainCount (BinaryRelation _ relatedFrom) = fromInteger $ DCM.getKeysCount relatedFrom
